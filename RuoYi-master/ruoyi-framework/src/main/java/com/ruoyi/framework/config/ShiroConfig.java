...
public class ShiroConfig
{
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager)
    {
        ...
        filterChainDefinitionMap.put("/system/sbjbxx/**", "anon");
        filterChainDefinitionMap.put("/system/jcsbxxt/**", "anon");
        filterChainDefinitionMap.put("/system/dwxxb/**", "anon");
        filterChainDefinitionMap.put("/system/bxdxx/**", "anon");
        filterChainDefinitionMap.put("/system/wxdgl/**", "anon");
        // 系统权限列表
